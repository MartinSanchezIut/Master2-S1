...
public class MapsPackageImpl extends EPackageImpl implements MapsPackage {
	 ...
	 * @generated
	 */
	public EReference getPublicSpace_Borderedfly() {
	...
	public void createPackageContents() {
		...
		createEReference(publicSpaceEClass, PUBLIC_SPACE__BORDEREDFLY);
	...
	public void initializePackageContents() {
		...
		initEReference(getPublicSpace_Borderedfly(), this.getRoad(), this.getRoad_Border(), "borderedfly", null, 1, -1, PublicSpace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRoad_Border(), this.getPublicSpace(), this.getPublicSpace_Borderedfly(), "border", null, 0, -1, Road.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
