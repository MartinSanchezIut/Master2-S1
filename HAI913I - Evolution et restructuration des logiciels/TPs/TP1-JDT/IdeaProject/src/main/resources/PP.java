...
abstract class Type extends Object{}//Type
...
abstract class PPExpr {
    ...
    abstract String toUPP (ArrayList<String> locals);
...
class PPInv extends PPUnOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        return new UPPSub(new UPPCte(0), e.toUPP(locals));//To do
    }//toUPP
...
class PPEq extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        return new UPPEq(e1.toUPP(locals), e2.toUPP(locals));//To do
    }//toUPP
...
class PPNe extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        return new UPPNe(e1.toUPP(locals), e2.toUPP(locals));//To do
    }//toUPP
...
class PPGe extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        return new UPPGe(e1.toUPP(locals), e2.toUPP(locals));//To do
    }//toUPP
...
class PPGt extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        return new UPPGt(e1.toUPP(locals), e2.toUPP(locals));//To do
    }//toUPP
...
class PPArrayGet extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        ...
        return new UPPAdd(arr.toUPP(locals), new UPPMul(new UPPCte(4), index.toUPP(locals)));
...
class PPArraySet extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {
        ...
        return new UPPStore(new UPPAdd(new UPPMul(new UPPCte(4),index.toUPP(locals)), arr.toUPP(locals)) ,val.toUPP(locals));
        //To do
    }//toUPP
...
class PPWhile extends PPInst {
    ...
    UPPInst toUPP (ArrayList<String> locals) {
        return new UPPWhile(cond.toUPP(locals),i.toUPP(locals));//To do
    }//toUPP
...
class PPProcCall extends PPInst {
    ...
    UPPInst toUPP (ArrayList<String> locals) {
        ArrayList<UPPExpr> aargs = new ArrayList<UPPExpr>();
        for (PPExpr a : args)
            aargs.add(a.toUPP(locals));
        return new UPPProcCall(callee,aargs) ;//To do
    }//toUPP
...
class PPProc extends PPDef {
    ...
    UPPDef toUPP () {
        ...
        ArrayList<String> alocals = new ArrayList<String>();
        ...
        return new UPPProc(name,aargs,alocals,code.toUPP(aall)) ;
        //To do
    }//toUPP
