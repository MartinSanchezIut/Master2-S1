...
public class ListCategorieRechercheAdaptateur extends BaseAdapter {

    private Context context;
    private List<Catégorie> list;
    private LayoutInflater inflater;

    public ListCategorieRechercheAdaptateur(Context context, List<Catégorie> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflater.inflate(R.layout.list_categorie_recherche,null);
