...
public class ProductRepository {
    ...
    public void addProduct(Product u) throws Exception {
        ...
        products.add(u) ;
        logger.info(logprefix  + "Product ID = " + u.getId() + " add to ProductRepository");
    }

    public Product getProductById(Long id) throws Exception{
            for (Product u : products) {
                if (u.getId() == id){
                    logger.info(logprefix  +"Product ID = " + id + " is found");
                    return u;
                }
            }
            logger.info(logprefix  +"Product ID = " + id + " is not found");
    ...
    public void removeProduct(Long id) throws Exception {
        ...
        logger.info(logprefix  +"Product with id = " + id + " is remove");
    }
    ...
    public Product editProduct(Long id, Product u) throws Exception {
        ...
        u.setId(id);
        addProduct(u);
        logger.info(logprefix  +"Product with id = " + id + " is edited");
        return u;
    }
}
